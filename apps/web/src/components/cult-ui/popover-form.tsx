      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            {showCloseButton && (
              <div className="absolute -top-[5px] left-1/2 z-20 flex h-[26px] w-[12px] -translate-x-1/2 items-center justify-center">
                <button
                  type="button"
...
export function PopoverFormButton({
  ...
  return (
    <button
      type="submit"
      className={cn(
        "ml-auto flex h-6 w-26 items-center justify-center overflow-hidden rounded-md px-3 text-xs font-semibold",
...
export function PopoverFormSuccess({
  ...
  return (
    <>
      ...
      <p className="mx-auto max-w-xs text-pretty text-center text-sm text-muted-foreground">
        {description}
      </p>
    </>
  )
